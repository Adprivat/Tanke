...
public class WorkshopServiceUpgrade extends Upgrade {
    private final double serviceRevenue;

    public WorkshopServiceUpgrade(String id, String name, String description, double cost, List<String> prerequisites, double serviceRevenue) {
