...
public class CarWashServiceUpgrade extends Upgrade {
    private final double serviceRevenue;

    public CarWashServiceUpgrade(String id, String name, String description, double cost, List<String> prerequisites, double serviceRevenue) {
        super(id, name, description, cost, UpgradeCategory.CAR_WASH, prerequisites);
