...
public class OrderAutomationUpgrade extends Upgrade {
    private final FuelType fuelType;

    public OrderAutomationUpgrade(String id, String name, String description, double cost, List<String> prerequisites, FuelType fuelType) {
    ...
    public List<UpgradeEffect> getEffects() {
        // Keine direkten Effekte, sondern Freischaltung der Automatisierung
        return List.of();
    }
